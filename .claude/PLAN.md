...
- [ ] Document Python version constraint **3.10–3.12** everywhere (README, REQUIREMENTS, INSTALL): >=3.10 for match/case, <=3.12 because pinned numpy 1.26.4/matplotlib 3.8.4 have no wheels for 3.13+ (found 2026-07-20: Felix's Windows py launcher used a newer Python → pip tried to build numpy from source). Dockerfile must pin python:3.12.
