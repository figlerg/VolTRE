...
plt.tight_layout()
plt.savefig(join('tests', 'test_out', 'vol_00.png'))
plt.clf()

vol1 = slice_volume(ctx1, n = 2)
vol1.plot(no_show=True)
plt.tight_layout()
plt.savefig(join('tests', 'test_out', 'vol_01.png'))
plt.clf()

vol2 = slice_volume(ctx2, n = 2)
vol2.plot(no_show=True)
plt.tight_layout()
plt.savefig(join('tests', 'test_out', 'vol_02.png'))
plt.clf()

vol3 = slice_volume(ctx3, n = 2)
vol3.plot(no_show=True)
plt.tight_layout()
plt.savefig(join('tests', 'test_out', 'vol_03.png'))
plt.clf()

vol4 = slice_volume(ctx4, n = 8)
vol4.plot(no_show=True)
plt.tight_layout()
plt.savefig(join('tests', 'test_out', 'vol_04.png'))
plt.clf()
