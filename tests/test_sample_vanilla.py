...
# standard example
tests.append((os.path.join(_E, 'spec_00.tre'), 3, None, False))
tests.append((os.path.join(_E, 'spec_00.tre'), 0, None, False))
tests.append((os.path.join(_E, 'spec_00.tre'), -27, None, True))    # invalid input

tests.append((os.path.join(_E, 'spec_01.tre'), 4, None, False))
tests.append((os.path.join(_E, 'spec_02.tre'), 2, None, False))
tests.append((os.path.join(_E, 'spec_03.tre'), 2, None, True))      # vanilla invalid, domain inf
tests.append((os.path.join(_E, 'spec_03.tre'), 2, 0.5, False))
tests.append((os.path.join(_E, 'spec_04.tre'), 4, None, True))      # vanilla invalid, domain inf
tests.append((os.path.join(_E, 'spec_04.tre'), 6, 27.5, False))
tests.append((os.path.join(_E, 'spec_05.tre'), 1, None, False))
tests.append((os.path.join(_E, 'spec_06.tre'), 6, None, False))


# intersection tests
tests.append((os.path.join(_E, 'spec_12_intersection.tre'), 3, 1.5, False))
tests.append((os.path.join(_E, 'spec_12_intersection.tre'), 7, 2, False))
tests.append((os.path.join(_E, 'spec_12_intersection.tre'), 5, 2.5, False))
tests.append((os.path.join(_E, 'spec_12_intersection.tre'), 1, 3, False))

# TAKiller with n = 15. This was autogenerated by my script. will take longer
tests.append((os.path.join(_E, 'TAKiller_15_gen.tre'), 3, None, False))
tests.append((os.path.join(_E, 'TAKiller_15_gen.tre'), 5, None, False))
